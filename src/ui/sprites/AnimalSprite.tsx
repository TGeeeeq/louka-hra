...
function Hen({ pal }: P) {
  return (
    <g>
      ...
      {/* ocas */}
      <path d="M18 60 Q6 48 14 44 Q16 54 24 56 Z" fill={pal.bodyDark} />
      <path d="M16 64 Q2 56 10 50 Q14 60 22 60 Z" fill={pal.body} />
      {/* tělo */}
      <ellipse cx={38} cy={62} rx={22} ry={20} fill={pal.body} />
      <ellipse cx={40} cy={68} rx={15} ry={12} fill={pal.belly} opacity={0.6} />
      <ellipse cx={34} cy={60} rx={9} ry={11} fill={pal.bodyDark} opacity={0.5} />
      {/* hlava */}
      <circle cx={58} cy={44} r={14} fill={pal.body} />
      {/* hřebínek */}
...
function Goose({ pal }: P) {
  return (
    <g>
      ...
      <ellipse cx={40} cy={66} rx={24} ry={17} fill={pal.body} />
      <ellipse cx={36} cy={70} rx={16} ry={11} fill={pal.belly} opacity={0.7} />
      <path d="M58 36 Q60 22 54 16" stroke={pal.body} strokeWidth={11} fill="none" strokeLinecap="round" />
      <circle cx={54} cy={18} r={9} fill={pal.body} />
...
function Duck({ pal, variant }: P) {
  const head = variant === "mallard" ? pal.bodyDark : pal.body;
  return (
    <g>
      <ellipse cx={40} cy={84} rx={16} ry={4} fill="#000" opacity={0.12} />
      <ellipse cx={38} cy={66} rx={23} ry={16} fill={pal.body} />
      <ellipse cx={34} cy={70} rx={15} ry={10} fill={pal.belly} opacity={0.7} />
      ...
      <circle cx={56} cy={26} r={11} fill={head} />
      {variant === "mallard" && <path d="M46 30 Q56 33 66 30" stroke="#e8e2d0" strokeWidth={1.6} fill="none" />}
...
function Dove({ pal }: P) {
  return (
    <g>
      ...
      <ellipse cx={42} cy={62} rx={21} ry={18} fill={pal.body} />
      <ellipse cx={40} cy={68} rx={13} ry={10} fill={pal.belly} opacity={0.7} />
      <path d="M22 58 Q16 54 20 50 Q26 56 30 58 Z" fill={pal.bodyDark} />
      <circle cx={60} cy={46} r={12} fill={pal.body} />
...
function Pig({ pal, variant }: P) {
  ...
  return (
    <g>
      ...
      <ellipse cx={50} cy={62} rx={30} ry={22} fill={pal.body} />
      <ellipse cx={52} cy={70} rx={20} ry={13} fill={pal.belly} opacity={0.55} />
      ...
      {/* hlava + rypák */}
      <circle cx={66} cy={56} r={18} fill={pal.body} />
      ...
      {/* nožky */}
      <rect x={36} y={80} width={6} height={8} rx={2} fill={pal.bodyDark} />
      <rect x={58} y={80} width={6} height={8} rx={2} fill={pal.bodyDark} />
    </g>
  );
}
...
function Donkey({ pal }: P) {
  return (
    <g>
      ...
      <ellipse cx={46} cy={58} rx={27} ry={19} fill={pal.body} />
      <ellipse cx={46} cy={66} rx={18} ry={11} fill={pal.belly} opacity={0.6} />
      {/* ocas */}
      ...
      {/* hlava */}
      <ellipse cx={70} cy={50} rx={14} ry={15} fill={pal.body} />
      <ellipse cx={78} cy={58} rx={9} ry={8} fill={pal.belly} />
      <circle cx={75} cy={58} r={1.6} fill={pal.detail} />
      <circle cx={81} cy={58} r={1.6} fill={pal.detail} />
      <Eye x={71} y={47} r={3} />
      {/* nohy */}
      <rect x={32} y={72} width={6} height={15} rx={2} fill={pal.bodyDark} />
      <rect x={52} y={72} width={6} height={15} rx={2} fill={pal.bodyDark} />
    </g>
  );
}
...
function Mouflon({ pal }: P) {
  return (
    <g>
      ...
      <ellipse cx={46} cy={60} rx={26} ry={18} fill={pal.body} />
      <ellipse cx={46} cy={67} rx={17} ry={10} fill={pal.belly} opacity={0.55} />
      <path d="M22 56 q-6 6 -2 14" stroke={pal.bodyDark} strokeWidth={3} fill="none" />
      <ellipse cx={70} cy={52} rx={14} ry={14} fill={pal.body} />
      <ellipse cx={78} cy={58} rx={8} ry={7} fill={pal.belly} />
      ...
      <rect x={34} y={74} width={5.5} height={13} rx={2} fill={pal.bodyDark} />
      <rect x={54} y={74} width={5.5} height={13} rx={2} fill={pal.bodyDark} />
    </g>
  );
}
...
function Cow({ pal, variant }: P) {
  return (
    <g>
      ...
      <ellipse cx={48} cy={58} rx={30} ry={21} fill={pal.body} />
      <ellipse cx={48} cy={66} rx={20} ry={12} fill={pal.belly} opacity={0.5} />
      {variant === "strakata" && (
        <>
      ...
      {/* hlava */}
      <ellipse cx={72} cy={50} rx={15} ry={14} fill={pal.body} />
      {/* růžky + uši */}
      ...
      <Eye x={70} y={46} r={3.2} />
      <Cheek x={64} y={53} />
      <rect x={36} y={76} width={6} height={12} rx={2} fill={pal.bodyDark} />
      <rect x={58} y={76} width={6} height={12} rx={2} fill={pal.bodyDark} />
    </g>
  );
}

function woolBumps(cx: number, cy: number, rx: number, ry: number, color: string) {
  const pts = [
  ...
  return (
    <g>
      ...
      {pts.map(([dx, dy], i) => (
        <circle key={i} cx={cx + dx} cy={cy + dy} r={ry * 0.5} fill={color} />
      ))}
    </g>
  );
}
...
function Sheep({ pal, variant }: P) {
  ...
  return (
    <g>
      ...
      {woolBumps(44, 58, 24, 18, pal.body)}
      <ellipse cx={44} cy={60} rx={12} ry={9} fill={pal.belly} opacity={0.5} />
      {/* hlava */}
      <ellipse cx={70} cy={52} rx={12} ry={13} fill={pal.detail} />
      <ellipse cx={70} cy={46} rx={11} ry={8} fill={old ? pal.bodyDark : pal.detail} />
      {/* ofina vlny */}
      <circle cx={66} cy={42} r={5} fill={pal.body} />
      <circle cx={74} cy={42} r={5} fill={pal.body} />
      {/* uši */}
      ...
      <rect x={34} y={74} width={5} height={13} rx={2} fill={pal.detail} />
      <rect x={52} y={74} width={5} height={13} rx={2} fill={pal.detail} />
    </g>
  );
}
...
function Dog({ pal, variant }: P) {
  ...
  return (
    <g>
      ...
      {shaggy ? woolBumps(46, 60, 26, 19, pal.body) : <ellipse cx={46} cy={60} rx={26} ry={19} fill={pal.body} />}
      <ellipse cx={48} cy={67} rx={17} ry={11} fill={pal.belly} opacity={0.6} />
      ...
      <circle cx={72} cy={52} r={15} fill={pal.body} />
      <ellipse cx={80} cy={58} rx={9} ry={7} fill={pal.belly} />
      <ellipse cx={84} cy={56} rx={3.4} ry={2.8} fill={pal.detail} />
      <Eye x={68} y={48} r={3.2} />
      <Eye x={78} y={49} r={3} />
      <path d="M82 61 q-2 4 -4 4" stroke={pal.accent} strokeWidth={2} fill="none" />
      <rect x={36} y={74} width={6} height={13} rx={2.5} fill={pal.bodyDark} />
      <rect x={56} y={74} width={6} height={13} rx={2.5} fill={pal.bodyDark} />
    </g>
  );
}
...
function Cat({ pal, variant }: P) {
  ...
  return (
    <g>
      ...
      {variant === "shaggy" ? woolBumps(46, 62, 23, 17, pal.body) : <ellipse cx={46} cy={62} rx={23} ry={17} fill={pal.body} />}
      <ellipse cx={48} cy={69} rx={14} ry={9} fill={pal.belly} opacity={0.65} />
      {variant === "calico" && (
        <>
      ...
      <circle cx={72} cy={50} r={15} fill={pal.body} />
      {/* oči */}
      ...
      <rect x={38} y={76} width={5.5} height={11} rx={2.5} fill={pal.body} />
      {!tripod && <rect x={56} y={76} width={5.5} height={11} rx={2.5} fill={pal.body} />}
    </g>
  );
}
...
function Rabbit({ pal }: P) {
  return (
    <g>
      ...
      <ellipse cx={44} cy={66} rx={22} ry={16} fill={pal.body} />
      <ellipse cx={46} cy={70} rx={13} ry={9} fill={pal.belly} opacity={0.7} />
      <circle cx={22} cy={64} r={6} fill={pal.belly} />
      <circle cx={64} cy={54} r={15} fill={pal.body} />
      <Eye x={60} y={52} r={3} />
      <Eye x={70} y={52} r={3} />
