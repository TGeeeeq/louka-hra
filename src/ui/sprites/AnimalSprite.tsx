...
function VolumeDefs({ pal, pfx }: { pal: SpritePalette; pfx: string }) {
  const body = pal.body;
  ...
  return (
    <defs>
      ...
      <radialGradient id={`${pfx}detail`} cx="36%" cy="28%" r="78%">
...
/** Props rendererů: paleta, varianty a `u("body")` → odkaz na vlastní gradient. */
type P = { pal: SpritePalette; variant?: string; u: (n: string) => string };

function Hen({ pal, u }: P) {
  return (
    <g>
      <ellipse cx={36} cy={84} rx={14} ry={4} fill="#000" opacity={0.12} />
      {/* ocas */}
      <path d="M18 60 Q6 48 14 44 Q16 54 24 56 Z" fill={u("dark")} />
      <path d="M16 64 Q2 56 10 50 Q14 60 22 60 Z" fill={u("body")} />
      {/* tělo */}
      <ellipse cx={38} cy={62} rx={22} ry={20} fill={u("body")} />
      <ellipse cx={40} cy={68} rx={15} ry={12} fill={u("belly")} opacity={0.6} />
      <ellipse cx={34} cy={60} rx={9} ry={11} fill={pal.bodyDark} opacity={0.5} />
      {/* hlava */}
      <circle cx={58} cy={44} r={14} fill={u("head")} />
      {/* hřebínek */}
...
function Goose({ pal, u }: P) {
  return (
    <g>
      <ellipse cx={42} cy={84} rx={16} ry={4} fill="#000" opacity={0.12} />
      <ellipse cx={40} cy={66} rx={24} ry={17} fill={u("body")} />
      <ellipse cx={36} cy={70} rx={16} ry={11} fill={u("belly")} opacity={0.7} />
      <path d="M58 36 Q60 22 54 16" stroke={pal.body} strokeWidth={11} fill="none" strokeLinecap="round" />
      <circle cx={54} cy={18} r={9} fill={u("head")} />
...
function Duck({ pal, variant, u }: P) {
  const mallard = has(variant, "mallard");
  const head = mallard ? pal.bodyDark : pal.body;
  const headFill = mallard ? u("dark") : u("head");
  return (
    <g>
      <ellipse cx={40} cy={84} rx={16} ry={4} fill="#000" opacity={0.12} />
      <ellipse cx={38} cy={66} rx={23} ry={16} fill={u("body")} />
      <ellipse cx={34} cy={70} rx={15} ry={10} fill={u("belly")} opacity={0.7} />
...
function Dove({ pal, u }: P) {
  return (
    <g>
      <ellipse cx={42} cy={84} rx={14} ry={4} fill="#000" opacity={0.12} />
      <ellipse cx={42} cy={62} rx={21} ry={18} fill={u("body")} />
      <ellipse cx={40} cy={68} rx={13} ry={10} fill={u("belly")} opacity={0.7} />
      <path d="M22 58 Q16 54 20 50 Q26 56 30 58 Z" fill={u("dark")} />
      <circle cx={60} cy={46} r={12} fill={u("head")} />
...
function Pig({ pal, variant, u }: P) {
  ...
  return (
    <g>
      ...
      <ellipse cx={50} cy={62} rx={30} ry={22} fill={u("body")} />
      <ellipse cx={52} cy={70} rx={20} ry={13} fill={u("belly")} opacity={0.55} />
      ...
      {/* nožky */}
      <rect x={36} y={80} width={6} height={8} rx={2} fill={u("dark")} />
      <rect x={58} y={80} width={6} height={8} rx={2} fill={u("dark")} />
    </g>
  );
}

function Donkey({ pal, u }: P) {
  return (
    <g>
      <ellipse cx={48} cy={86} rx={26} ry={5} fill="#000" opacity={0.12} />
      <ellipse cx={46} cy={58} rx={27} ry={19} fill={u("body")} />
      <ellipse cx={46} cy={66} rx={18} ry={11} fill={u("belly")} opacity={0.6} />
      ...
      {/* hlava */}
      <ellipse cx={70} cy={50} rx={14} ry={15} fill={u("head")} />
      <ellipse cx={78} cy={58} rx={9} ry={8} fill={u("belly")} />
      <circle cx={75} cy={58} r={1.6} fill={pal.detail} />
      <circle cx={81} cy={58} r={1.6} fill={pal.detail} />
      <Eye x={71} y={47} r={3} />
      {/* nohy */}
      <rect x={32} y={72} width={6} height={15} rx={2} fill={u("dark")} />
      <rect x={52} y={72} width={6} height={15} rx={2} fill={u("dark")} />
    </g>
  );
}

function Mouflon({ pal, u }: P) {
  return (
    <g>
      <ellipse cx={48} cy={86} rx={25} ry={5} fill="#000" opacity={0.12} />
      <ellipse cx={46} cy={60} rx={26} ry={18} fill={u("body")} />
      <ellipse cx={46} cy={67} rx={17} ry={10} fill={u("belly")} opacity={0.55} />
      <path d="M22 56 q-6 6 -2 14" stroke={pal.bodyDark} strokeWidth={3} fill="none" />
      <ellipse cx={70} cy={52} rx={14} ry={14} fill={u("head")} />
      <ellipse cx={78} cy={58} rx={8} ry={7} fill={u("belly")} />
      ...
      <rect x={34} y={74} width={5.5} height={13} rx={2} fill={u("dark")} />
      <rect x={54} y={74} width={5.5} height={13} rx={2} fill={u("dark")} />
    </g>
  );
}

function Cow({ pal, variant, u }: P) {
  return (
    <g>
      <ellipse cx={50} cy={87} rx={28} ry={5} fill="#000" opacity={0.12} />
      <ellipse cx={48} cy={58} rx={30} ry={21} fill={u("body")} />
      <ellipse cx={48} cy={66} rx={20} ry={12} fill={u("belly")} opacity={0.5} />
      ...
      <Eye x={70} y={46} r={3.2} />
      <Cheek x={64} y={53} />
      <rect x={36} y={76} width={6} height={12} rx={2} fill={u("dark")} />
      <rect x={58} y={76} width={6} height={12} rx={2} fill={u("dark")} />
    </g>
  );
}
...
function Sheep({ pal, variant, u }: P) {
  ...
  return (
    <g>
      ...
      {/* ofina vlny */}
      <circle cx={66} cy={42} r={5} fill={u("body")} />
      <circle cx={74} cy={42} r={5} fill={u("body")} />
      {ofina && (
        <>
          <circle cx={62} cy={45} r={4.5} fill={u("body")} />
          <circle cx={70} cy={40} r={5.5} fill={u("body")} />
          <circle cx={78} cy={45} r={4.5} fill={u("body")} />
        </>
      )}
      ...
      <rect x={34} y={74} width={5} height={13} rx={2} fill={u("detail")} />
      <rect x={52} y={74} width={5} height={13} rx={2} fill={u("detail")} />
    </g>
  );
}

function Dog({ pal, variant, u }: P) {
  ...
  return (
    <g>
      ...
      {shaggy || scruffy ? woolBumps(46, 60, 26, 19, u("body")) : <ellipse cx={46} cy={60} rx={26} ry={19} fill={u("body")} />}
      <ellipse cx={48} cy={67} rx={17} ry={11} fill={u("belly")} opacity={0.6} />
      ...
      <ellipse cx={80} cy={58} rx={9} ry={7} fill={u("belly")} />
      ...
      <rect x={36} y={74} width={6} height={13} rx={2.5} fill={u("dark")} />
      <rect x={56} y={74} width={6} height={13} rx={2.5} fill={u("dark")} />
    </g>
  );
}

function Cat({ pal, variant, u }: P) {
  ...
  return (
    <g>
      ...
      {has(variant, "shaggy") ? woolBumps(46, 62, 23, 17, u("body")) : <ellipse cx={46} cy={62} rx={23} ry={17} fill={u("body")} />}
      <ellipse cx={48} cy={69} rx={14} ry={9} fill={u("belly")} opacity={0.65} />
      {has(variant, "calico") && (
        <>
      ...
      <circle cx={72} cy={50} r={15} fill={u("head")} />
      {/* oči */}
      ...
      <rect x={38} y={76} width={5.5} height={11} rx={2.5} fill={u("body")} />
      {!tripod && <rect x={56} y={76} width={5.5} height={11} rx={2.5} fill={u("body")} />}
    </g>
  );
}

function Rabbit({ pal, u }: P) {
  return (
    <g>
      ...
      <ellipse cx={44} cy={66} rx={22} ry={16} fill={u("body")} />
      <ellipse cx={46} cy={70} rx={13} ry={9} fill={u("belly")} opacity={0.7} />
      <circle cx={22} cy={64} r={6} fill={pal.belly} />
      <circle cx={64} cy={54} r={15} fill={u("head")} />
      <Eye x={60} y={52} r={3} />
      <Eye x={70} y={52} r={3} />
...
function Fox({ pal, u }: P) {
  return (
    <g>
      <ellipse cx={48} cy={86} rx={25} ry={5} fill="#000" opacity={0.12} />
      {/* huňatý ocas s bílou špičkou — poznávací znak */}
      <path d="M26 62 Q8 66 6 52 Q12 56 16 52 Q20 60 30 58 Z" fill={u("body")} />
      <path d="M10 56 Q6 52 8 49 Q11 52 14 52 Z" fill={pal.accent} />
      {/* tělo */}
      <ellipse cx={46} cy={62} rx={24} ry={17} fill={u("body")} />
      <ellipse cx={50} cy={68} rx={15} ry={10} fill={u("belly")} opacity={0.8} />
      ...
      <circle cx={72} cy={50} r={14} fill={u("head")} />
...
function Hedgehog({ pal, u }: P) {
  ...
  return (
    <g>
      ...
      {spikes}
      {/* bodlinové tělo */}
      <ellipse cx={44} cy={62} rx={24} ry={19} fill={u("dark")} />
      {/* světlý obličej */}
      <path d="M58 52 Q76 54 82 66 Q74 76 60 74 Q52 66 58 52 Z" fill={u("belly")} />
...
function Deer({ pal, u }: P) {
  return (
    <g>
      ...
      {/* štíhlé tělo */}
      <ellipse cx={46} cy={58} rx={23} ry={15} fill={u("body")} />
      <ellipse cx={48} cy={63} rx={14} ry={8} fill={u("belly")} opacity={0.55} />
      {/* krk + hlava výš — elegantní postoj */}
      <path d="M62 52 Q66 38 68 32" stroke={pal.body} strokeWidth={11} fill="none" strokeLinecap="round" />
      <ellipse cx={70} cy={28} rx={11} ry={10} fill={u("head")} />
      {/* velké uši */}
      ...
      {/* čumáček */}
      <ellipse cx={78} cy={32} rx={5} ry={4} fill={u("belly")} />
      <ellipse cx={81} cy={31} rx={2.2} ry={1.9} fill={pal.detail} />
      <Eye x={70} y={26} r={3} />
      {/* dlouhé štíhlé nohy */}
      <rect x={32} y={70} width={4} height={17} rx={2} fill={u("dark")} />
      <rect x={42} y={71} width={4} height={16} rx={2} fill={u("dark")} />
      <rect x={54} y={71} width={4} height={16} rx={2} fill={u("dark")} />
      <rect x={62} y={70} width={4} height={17} rx={2} fill={u("dark")} />
    </g>
  );
}
...
export function AnimalSprite({
  ...
  // Prefix gradientů podle id zvířete — unikátní v celém DOM (viz VolumeDefs).
  const pfx = `sg-${animal.id}-`;
  ...
  return (
    ...
    >
      <VolumeDefs pal={animal.palette} pfx={pfx} />
      <Renderer pal={animal.palette} variant={animal.variant} u={u} />
    </svg>
  );
}
