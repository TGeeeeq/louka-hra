...
function HeadFront({ variant, u }: { variant?: string; u: (n: string) => string }) {
  return (
    <g>
      <circle cx={50} cy={42} r={17} fill={u("skin")} />
      <path d="M33 40 Q33 22 50 22 Q67 22 67 40 Q60 30 50 30 Q40 30 33 40 Z" fill={u("hair")} />
      {variant === "ponytail" && (
        <>
          <ellipse cx={70} cy={42} rx={5} ry={11} fill={u("hair")} />
          <circle cx={66} cy={31} r={3} fill={u("hair")} />
        </>
      )}
      {variant === "hat" && (
        <>
      ...
      {variant === "beard" && <path d="M37 47 Q39 62 50 62 Q61 62 63 47 Q57 56 50 56 Q43 56 37 47 Z" fill={u("hair")} />}
    </g>
  );
}

function HeadBack({ variant, u }: { variant?: string; u: (n: string) => string }) {
  return (
    <g>
...
function HeadSide({ variant, u }: { variant?: string; u: (n: string) => string }) {
  return (
    <g>
      <circle cx={50} cy={42} r={17} fill={u("skin")} />
      {/* vlasy vzadu (vlevo) a nahoře */}
      <path d="M33 44 Q31 22 50 22 Q60 22 63 30 Q54 28 46 30 Q37 33 36 46 Z" fill={u("hair")} />
      {variant === "hat" && (
        <>
